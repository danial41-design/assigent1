...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner scanner = new Scanner(new File("C:\\Users\\aser\\IdeaProjects\\assign2\\src\\Students"));
    ...
    scanner = new Scanner(new File("C:\\Users\\aser\\IdeaProjects\\assign2\\src\\Teachers"));
        while (scanner.hasNextLine()) {
